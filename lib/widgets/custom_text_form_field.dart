...
extension TextFormFieldStyleHelper on CustomTextFormField {
  ...
  static OutlineInputBorder get fillOnPrimary1 => OutlineInputBorder(
        borderSide: BorderSide.none,
      );
  ...
  static UnderlineInputBorder get underLineBlue1 => UnderlineInputBorder(
        borderSide: BorderSide(
          color: appTheme.blue100.withOpacity(0.53),
        ),
      );
}
